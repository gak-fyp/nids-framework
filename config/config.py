...
# Configuration for NSL-KDD Dataset
...
head = {' Fwd IAT Max', ' Bwd Avg Bytes/Bulk', ' Flow Packets/s', ' Packet Length Variance', 'FIN Flag Count',
        ' Average Packet Size', 'Flow Bytes/s', ' Max Packet Length', ' Flow IAT Mean', ' Flow IAT Min',
        ' Bwd PSH Flags','Fwd PSH Flags', ' Packet Length Std', ' RST Flag Count', ' Subflow Fwd Bytes',
        ' Avg Bwd Segment Size', ' Idle Std', ' Flow Duration', ' Bwd IAT Std', 'Total Length of Fwd Packets',
        'Fwd Avg Bytes/Bulk', ' ECE Flag Count', ' act_data_pkt_fwd', ' Active Std', ' Idle Max', ' Min Packet Length',
        ' Flow IAT Max', 'Active Mean', 'Idle Mean',' Active Min', ' Fwd Packet Length Mean', ' PSH Flag Count',
        ' Subflow Bwd Packets', ' Fwd Avg Packets/Bulk',' Bwd Packet Length Std', ' Packet Length Mean',
        'Init_Win_bytes_forward', ' URG Flag Count', ' Total Length of Bwd Packets',' Total Backward Packets',
        'Bwd Avg Bulk Rate', ' min_seg_size_forward', ' Active Max', ' Bwd IAT Mean', ' Fwd Header Length.1',
        ...
        ' Idle Min', ' Fwd Packet Length Min', ' Bwd URG Flags', ' Down/Up Ratio', ' Flow IAT Std',
        'Bwd Packet Length Max',' Fwd IAT Min', ' Init_Win_bytes_backward', ' Bwd IAT Min', ' SYN Flag Count',
